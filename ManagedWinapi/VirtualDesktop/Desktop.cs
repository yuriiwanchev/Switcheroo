...
namespace ManagedWinapi.VirtualDesktop
{
	public class Desktop
	{
		...
		public static Desktop FromWindow(IntPtr hWnd)
		{
			...
			var dm = DesktopManager.Manager.FindDesktop(ref id);
			return new Desktop(dm);
		}
	...
	internal static class DesktopManager
	{
		static DesktopManager()
		{
			...
			Manager = (IVirtualDesktopManagerInternal)shell.QueryService(
				Guids.CLSID_VirtualDesktopManagerInternal, Guids.IID_IVirtualDesktopManagerInternal);
